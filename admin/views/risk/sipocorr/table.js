			...
			rows:[
				{
					...
					columns:[
						...
						//template:"<a class='link' target='_blank' href='http://172.20.40.15/qasystems/docs/file/#file1#'>#no#</a>"},
						{ id:"name",  fillspace:true,	header:["Document Name",{ content:"serverFilter"}], sort:"server"},
						{ id:"rev_no",	header:["Rev."], width:50},
						{ id:"detail", header:"Action", width:70, template:"<a class='detail' href='#!/app/risk.sipocorr.index'>Detail</a>"}
					...
					"detail":function(e, id, trg){
						...
						this.$scope.show("risk.sipocorr.index:id="+id);
