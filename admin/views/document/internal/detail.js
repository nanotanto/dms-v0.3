	...
	var grid = {rows:[
		...
		columns:[
			...
			{ 
				...
				header:["Doc. No."], 
				width:100,	 
				template:"<a class='link' target='_blank' href='"+url+"../pdf/web/viewer.html?file=../../ISO9001/internal/#file1#'>#no#</a>"
	...
	var form = {
		...
		rows:[
			...
			},
			{
				...
				labelWidth:150, 
				readonly:true,
				options:{ },url:url+"../backend/lumen/public/sec/index"
			},		
			{
				view:"text", 
				name:"remark", 
			...
			},	
			{
				cols:[
					...
					value:"View", click:function(){
						...
						window.open(+url+"../pdf/web/viewer.html?file=../../ISO9001/internal/"+file+"");						
			...
			},
			{
				cols:[
					...
					value:"Download", click:function(){
						...
						//window.open(url+"lumen/public/file/"+id+"");
						window.open(+url+"../pdf/web/viewer.html?file=../../ISO9001/internal/"+id+"");
					}},
				]
			},
			{}
